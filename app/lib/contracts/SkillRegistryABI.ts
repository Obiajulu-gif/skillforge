export const SkillRegistryABI = {
  contractAddress: process.env.NEXT_PUBLIC_SKILL_REGISTRY_ADDRESS as string,
  abi: [
    {
      "inputs": [],
      ...
      "outputs": [
        {
          "components": [
            ...
            { "internalType": "uint256", "name": "lifetimePrice", "type": "uint256" },
            { "internalType": "enum SkillRegistry.PricingModel", "name": "pricingModel", "type": "uint8" },
